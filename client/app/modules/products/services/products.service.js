            ...
            templateOptions: {
              label: gettextCatalog.getString('weight')
                ...
                },
                {
                  ...
                  type: 'input',
                  templateOptions: {
                    label: gettextCatalog.getString('Qty')
                  }
                },
                {
                  key: 'futures',
                  type: 'input',
                  templateOptions: {
                    label: gettextCatalog.getString('Futures')
                  }
                },
                {
                  ...
                  type: 'input',
                  templateOptions: {
                    label: gettextCatalog.getString('Profit %')
                  }
                },
                {
                  key: 'allow_order',
                ...
                },
                {
                  ...
                  type: 'input',
                  templateOptions: {
                    label: gettextCatalog.getString('Shipping Cost')
                  }
                }
        ];
      };
